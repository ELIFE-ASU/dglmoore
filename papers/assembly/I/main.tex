...
A natural way of graphically representing this $P$ is with a bipartite multigraph:
...
\begin{figure}[!h]
    ...
    \begin{tikzpicture}
        ...
        \begin{pgfonlayer}{edgelayer}
            \draw [style=inarrow, bend right=15] (A) to (tau1);
            \draw [style=inarrow, bend left=15] (A) to (tau1);
            \draw [style=inarrow, bend right=15] (A) to (tau2);
            \draw [style=inarrow] (tau1) to (AA);
            \draw [style=inarrow] (B) to (tau2);
            \draw [style=inarrow] (tau2) to (AB);
            \draw [style=inarrow] (AA) to (tau3);
            \draw [style=inarrow] (AB) to (tau3);
            \draw [style=inarrow, bend left=30] (C) to (tau3);
            \draw [style=inarrow] (tau3) to (AAAB);
            \draw [style=inarrow, bend left=30] (tau3) to (C);
            \draw [style=inarrow] (AAAB) to (tau4);
            \draw [style=inarrow, bend right=30] (tau4) to (A);
            \draw [style=inarrow, bend right=30] (tau4) to (AA);
            \draw [style=inarrow, bend left=40] (tau4) to (B);
        \end{pgfonlayer}
    \end{tikzpicture}
}
\end{figure}
...
\begin{figure}[!h]
    ...
    \begin{tikzpicture}
        ...
        \end{pgfonlayer}
        \begin{pgfonlayer}{edgelayer}
            \draw [style=inarrow, draw=gray!80, bend right=15] (A) to (tau1);
            \draw [style=inarrow, draw=gray!80, bend left=15] (A) to (tau1);
            \draw [style=inarrow, draw=gray!80, bend right=15] (A) to (tau2);
            \draw [style=inarrow, draw=gray!80] (tau1) to (AA);
            \draw [style=inarrow, draw=gray!80] (B) to (tau2);
            \draw [style=inarrow, draw=gray!80] (tau2) to (AB);
            \draw [style=inarrow, draw=gray!80] (AA) to (tau3);
            \draw [style=inarrow, draw=gray!80] (AB) to (tau3);
            \draw [style=inarrow, draw=gray!80, bend left=30] (C) to (tau3);
            \draw [style=inarrow, draw=gray!80] (tau3) to (AAAB);
            \draw [style=inarrow, draw=gray!80, bend left=30] (tau3) to (C);
            \draw [style=inarrow, draw=gray!80] (AAAB) to (tau4);
            \draw [style=inarrow, draw=gray!80, bend right=30] (tau4) to (A);
            \draw [style=inarrow, draw=gray!80, bend right=30] (tau4) to (AA);
            \draw [style=inarrow, draw=gray!80, bend left=40] (tau4) to (B);

            \draw [style=inarrow, draw=gray!80, bend left=15] (W) to (tau5);
            \draw [style=inarrow, draw=gray!80, bend right=15] (W) to (tau5);
            \draw [style=inarrow, draw=gray!80, bend left=15] (tau5) to (X);
            \draw [style=inarrow, draw=gray!80, bend right=15] (tau5) to (X);
            \draw [style=inarrow, draw=gray!80, bend left=15] (X) to (tau6);
            \draw [style=inarrow, draw=gray!80, bend right=15] (X) to (tau6);
            \draw [style=inarrow, draw=gray!80] (tau6) to (Y);
            \draw [style=inarrow, draw=gray!80, bend left=20] (Y) to (tau7);
            \draw [style=inarrow, draw=gray!80] (Y) to (tau7);
            \draw [style=inarrow, draw=gray!80, bend right=20] (Y) to (tau7);
            \draw [style=inarrow, draw=gray!80] (tau7) to (Z);
            \draw [style=inarrow, draw=gray!80, bend left=50] (tau7.south) to (Y.south);
            \draw [style=inarrow, draw=gray!80] (Z) to (tau8);
            \draw [style=inarrow, draw=gray!80, bend left=30] (tau8) to (X);
            \draw [style=inarrow, draw=gray!80, bend right=30] (tau8) to (X);
            \draw [style=inarrow, draw=gray!80, bend right=30] (tau8) to (Y);
...
\begin{figure}[!h]
    ...
    \begin{tikzpicture}
        ...
        \begin{pgfonlayer}{edgelayer}
            ...
            \draw [style=inarrow, draw=gray!80, bend left=15] (tau5) to (X);
            \draw [style=inarrow, draw=gray!80, bend right=15] (tau5) to (X);
            \draw [style=inarrow, draw=red, bend left=15] (X) to (tau6);
            \draw [style=inarrow, draw=red, bend right=15] (X) to (tau6);
            \draw [style=inarrow, draw=red] (tau6) to (Y);
            \draw [style=inarrow, draw=red, bend left=20] (Y) to (tau7);
            \draw [style=inarrow, draw=red] (Y) to (tau7);
            \draw [style=inarrow, draw=red, bend right=20] (Y) to (tau7);
            \draw [style=inarrow, draw=red] (tau7) to (Z);
            \draw [style=inarrow, draw=red, bend left=50] (tau7.south) to (Y.south);
            \draw [style=inarrow, draw=gray!80] (Z) to (tau8);
            \draw [style=inarrow, draw=gray!80, bend left=30] (tau8) to (X);
            \draw [style=inarrow, draw=gray!80, bend right=30] (tau8) to (X);
            \draw [style=inarrow, draw=gray!80, bend right=30] (tau8) to (Y);
...
\begin{figure}[!h]
    ...
    \begin{tikzpicture}
        ...
        \end{pgfonlayer}
        \begin{pgfonlayer}{edgelayer}
            \draw [style=inarrow, bend left=15] (tau1) to (A);
            \draw [style=inarrow, bend right=15] (tau1) to (B);
            \draw [style=inarrow, bend left=15] (A) to (tau2);
            \draw [style=inarrow, bend right=15] (B) to (tau2);
        \end{pgfonlayer}
    \end{tikzpicture}
}
\end{figure}
