...
These Petri net morphisms will play a crucial roll in the establishment of bounds for the assembly index in \Cref{sec:assembly-index}.
...
\begin{center}
    \scalebox{0.6}{
        \begin{tikzpicture}\label{ex:map}
            \begin{pgfonlayer}{nodelayer}
                \node [scale=3] (P) at (12, 0) {$P$};
                \node [style=site] (A) at (0, 0.8) {$A$};
                \node [style=site] (B) at (0, -0.8) {$B$};
...
\begin{definition}\label{def:pathway}
    ...
    \smallskip
    Let $X$ be a subset of sites in $P$. We say that $\gamma$ is \textit{from $X$} if $\pi(\sigma(t_1)) \subseteq X$, and will sometimes say that $\gamma$ starts at $X$. Let $y$ be site, and let $Y$ be a subset of sites.
    We say $\gamma$ is a \textit{to $y$} if $y \in \pi(\tau(t_n))$, and \textit{to $Y$} if $Y \subseteq \pi(\tau(t_n))$, and will sometimes say that $\gamma$ terminates at $y$ or $Y$. We say that the zero pathway is a pathway from any set $X$ to itself and none other.
...
\begin{center}
    \scalebox{0.6}{
        \begin{tikzpicture}
            \begin{pgfonlayer}{nodelayer}
                \node [scale=3] (P) at (12, 0) {$P$};
                \node [style=site, fill=blue!20] (A) at (0, 0.8) {$A$};
                \node [style=site, fill=blue!20] (B) at (0, -0.8) {$B$};
                \node [style=site] (C) at (6, -1.6) {$C$};
                \node [style=site, fill=red!20] (AA) at (4, 0.8) {$AA$};
                \node [style=site, fill=red!20] (AB) at (4, -0.8) {$AB$};
                \node [style=site] (AAAB) at (8, 0) {$AAAB$};
                \node [style=transition, fill=green!20] (tau1) at (2, 0.8) {$\alpha$};
                \node [style=transition, fill=green!20] (tau2) at (2, -0.8) {$\beta$};
                \node [style=transition] (tau3) at (6, 0) {$\gamma$};
                \node [style=transition] (tau4) at (10, 0) {$\delta$};

                \node [scale=3] (Q) at (12, -6) {$Q$};
                \node [style=site] (W) at (-4, -6) {$W$};
                \node [style=site, fill=blue!20] (X) at (0, -6) {$X$};
                \node [style=site, fill=red!20] (Y) at (4, -6) {$Y$};
                \node [style=site] (Z) at (8, -6) {$Z$};
                \node [style=transition] (tau5) at (-2, -6) {$\phi$};
                \node [style=transition, fill=green!20] (tau6) at (2, -6) {$\chi$};
                \node [style=transition] (tau7) at (6, -6) {$\psi$};
                \node [style=transition] (tau8) at (10, -6) {$\omega$};
            \end{pgfonlayer}
            \begin{pgfonlayer}{edgelayer}
                \draw [style=arrow, line width=1.5, draw=red, bend right=15] (A) to (tau1);
                \draw [style=arrow, line width=1.5, draw=red, bend left=15] (A) to (tau1);
                \draw [style=arrow, line width=1.5, draw=red, bend right=15] (A) to (tau2);
                \draw [style=arrow, line width=1.5, draw=red] (tau1) to (AA);
                \draw [style=arrow, line width=1.5, draw=red] (B) to (tau2);
                \draw [style=arrow, line width=1.5, draw=red] (tau2) to (AB);
                \draw [style=arrow, draw=gray!80] (AA) to (tau3);
                \draw [style=arrow, draw=gray!80] (AB) to (tau3);
                \draw [style=arrow, draw=gray!80, bend left=30] (C) to (tau3);
                \draw [style=arrow, draw=gray!80] (tau3) to (AAAB);
                ...
                \draw [style=sitemap, opacity=0.5, bend right=30, shorten >=2mm] (A) to (X);
                \draw [style=sitemap, opacity=0.5, bend right=30, shorten >=2mm] (B) to (X);
                \draw [style=sitemap, opacity=0.5, bend right=30, shorten >=2mm] (AA) to (Y);
                \draw [style=sitemap, opacity=0.5, bend right=30, shorten >=2mm] (AB) to (Y);
                \draw [style=sitemap, opacity=0.5, bend right=30, shorten >=2mm] (C) to (Y);
                \draw [style=sitemap, opacity=0.5, bend right=30, shorten >=2mm] (AAAB) to (Z);
                \draw [style=transitionmap, opacity=0.5, bend right=30, shorten >=2mm] (tau1) to (tau6);
                \draw [style=transitionmap, opacity=0.5, bend right=30, shorten >=2mm] (tau2) to (tau6);
                \draw [style=transitionmap, opacity=0.5, bend right=30, shorten >=2mm] (tau3) to (tau7);
                \draw [style=transitionmap, opacity=0.5, bend right=30, shorten >=2mm] (tau4) to (tau8);

                \draw [style=arrow, draw=gray!80, bend left=15] (W) to (tau5);
                \draw [style=arrow, draw=gray!80, bend right=15] (W) to (tau5);
                \draw [style=arrow, draw=gray!80, bend left=15] (tau5) to (X);
                \draw [style=arrow, draw=gray!80, bend right=15] (tau5) to (X);
                \draw [style=arrow, line width=1.5, draw=red, bend left=15] (X) to (tau6);
                \draw [style=arrow, line width=1.5, draw=red, bend right=15] (X) to (tau6);
                \draw [style=arrow, line width=1.5, draw=red] (tau6) to (Y);
                \draw [style=arrow, draw=gray!80, bend left=20] (Y) to (tau7);
                \draw [style=arrow, draw=gray!80] (Y) to (tau7);
                \draw [style=arrow, draw=gray!80, bend right=20] (Y) to (tau7);
                \draw [style=arrow, draw=gray!80] (tau7) to (Z);
...
\end{center}
Here the starting set of sites is highlight in blue, the terminal sites in red, the transitions in green and relevant edges are emboldened red.
    ...
    \scalebox{0.6}{
        \begin{tikzpicture}
            \begin{pgfonlayer}{nodelayer}
                ...
                \node [style=site, fill=blue!20] (A) at (0, 0.8) {$A$};
                \node [style=site] (B) at (0, -0.8) {$B$};
                \node [style=site, fill=blue!20] (C) at (6, -1.6) {$C$};
                \node [style=site] (AA) at (4, 0.8) {$AA$};
                \node [style=site, fill=blue!20] (AB) at (4, -0.8) {$AB$};
                \node [style=site] (AAAB) at (8, 0) {$AAAB$};
                \node [style=transition] (tau1) at (2, 0.8) {$\alpha$};
                \node [style=transition] (tau2) at (2, -0.8) {$\beta$};
                \node [style=transition] (tau3) at (6, 0) {$\gamma$};
                ...
                \node [style=site] (W) at (-4, -6) {$W$};
                \node [style=site, fill=blue!20] (X) at (0, -6) {$X$};
                \node [style=site, fill=blue!20] (Y) at (4, -6) {$Y$};
                \node [style=site] (Z) at (8, -6) {$Z$};
                \node [style=transition] (tau5) at (-2, -6) {$\phi$};
                \node [style=transition] (tau6) at (2, -6) {$\chi$};
                \node [style=transition] (tau7) at (6, -6) {$\psi$};
...
The ligation example, used throughout \Cref{sec:petri-nets} and reproduced below, is in fact an assembly space, provided we choose a generating set.
\begin{center}
    \scalebox{0.6}{
        \begin{tikzpicture}
            \begin{pgfonlayer}{nodelayer}
...
\end{center}
As previously discussed, this net admits four possible bases ($\{A,B,C\}$, $\{A,AB,C\}$, $\{AA,AB,C\}$, or $\{C,AAAB\}$) and numerous, non-minimal generating sets.
In the all of the examples in this sections, we use $G = \{A,B,C\}$ (highlighted in blue) as the particular generating set unless and refer to this this Petri net with $G$ as the assembly space $\A$.

Assembly spaces, as with Petri nets in general, admit a subnet structure.
In general, a Petri subnet need now have a specified generating set; however, we will require this of subnets of assembly spaces.
To distinguish the two concepts, we will refer exclusively to \textit{assembly subspaces} which are little more than Petri subnets with a chosen generating set.
...
\end{definition}
The example space $\A$ admits a number of subspaces, a few of which are depicted below.
\begin{center}
    \scalebox{0.6}{
        \begin{tikzpicture}
            \begin{pgfonlayer}{nodelayer}
                \node [style=site, fill=blue!20] (A) at (0,  1.6) {$A$};
                \node [style=site, fill=blue!20] (B) at (0,  0.0) {$B$};
                \node [style=site, fill=blue!20] (C) at (0, -1.6) {$C$};
                \node [scale=2] at (0, -3.6) {a.};

                \node [style=site, fill=blue!20] (A1) at (4,  0.8) {$A$};
                \node [style=site, fill=blue!20] (B1) at (4, -0.8) {$B$};
                \node [style=transition] (alpha) at (6, 0.8) {$\alpha$};
                \node [style=transition] (beta) at (6, -0.8) {$\beta$};
                \node [style=site] (AA1) at (8, 0.8) {$AA$};
                \node [style=site] (AB1) at (8, -0.8) {$AB$};
                \node [scale=2] at (6, -3.6) {b.};

                \node [style=site, fill=blue!20] (AA2) at (12, 0.8) {$AA$};
                \node [style=site, fill=blue!20] (AB2) at (12, -0.8) {$AB$};
                \node [style=site, fill=blue!20] (C2) at (14, -1.6) {$C$};
                \node [style=transition] (gamma) at (14, 0) {$\gamma$};
                \node [style=site] (AAAB) at (16, 0) {$AAAB$};
                \node [scale=2] at (14, -3.6) {c.};

                \node [style=site, fill=blue!20] (A3) at (20,  0.8) {$A$};
                \node [style=site, fill=blue!20] (B3) at (20, -0.8) {$B$};
                \node [style=transition] (alpha3) at (22, 0.8) {$\alpha$};
                \node [style=transition] (beta3) at (22, -0.8) {$\beta$};
                \node [style=site] (AA3) at (24, 0.8) {$AA$};
                \node [style=site] (AB3) at (24, -0.8) {$AB$};
                \node [style=site, fill=blue!20] (C3) at (26, -1.6) {$C$};
                \node [style=transition] (gamma3) at (26, 0) {$\gamma$};
                \node [style=site] (AAAB3) at (28, 0) {$AAAB$};
                \node [scale=2] at (24, -3.6) {d.};
            \end{pgfonlayer}
            \begin{pgfonlayer}{edgelayer}
                \draw [style=arrow, bend right=15] (A1) to (alpha);
                \draw [style=arrow, bend left=15] (A1) to (alpha);
                \draw [style=arrow, bend right=15] (A1) to (beta);
                \draw [style=arrow] (alpha) to (AA1);
                \draw [style=arrow] (B1) to (beta);
                \draw [style=arrow] (beta) to (AB1);

                \draw [style=arrow] (AA2) to (gamma);
                \draw [style=arrow] (AB2) to (gamma);
                \draw [style=arrow, bend left=30] (C2) to (gamma);
                \draw [style=arrow, bend left=30] (gamma) to (C2);
                \draw [style=arrow] (gamma) to (AAAB);

                \draw [style=arrow, bend right=15] (A3) to (alpha3);
                \draw [style=arrow, bend left=15] (A3) to (alpha3);
                \draw [style=arrow, bend right=15] (A3) to (beta3);
                \draw [style=arrow] (alpha3) to (AA3);
                \draw [style=arrow] (B3) to (beta3);
                \draw [style=arrow] (beta3) to (AB3);
                \draw [style=arrow] (AA3) to (gamma3);
                \draw [style=arrow] (AB3) to (gamma3);
                \draw [style=arrow, bend left=30] (C3) to (gamma3);
                \draw [style=arrow, bend left=30] (gamma3) to (C3);
                \draw [style=arrow] (gamma3) to (AAAB3);
            \end{pgfonlayer}
        \end{tikzpicture}
    }
\end{center}
In all of these cases, we've highlighted the chosen generating set for the subspace which is in fact the only basis for each.
Some of these subspaces are quite trivial, such as \textbf{a.}, while the others capture some information about the way in which some objects be be assembled.
In subspace \textbf{c.} we can see that the generating set has sites which are not in the generating set of $\A$, while the other spaces $\textbf{a.}$, $\textbf{b.}$ and $\textbf{d.}$ do not.
Consequently, \textbf{c.} does not tie the assembly of $AAAB$ to the chosen generating set of the $\A$.
Assembly subspaces whose generating set is a subset of the larger space will be referred to as \textit{rooted}.
\begin{definition}\label{def:rooted}
    Let $(A', G_{A'})$ be an assembly subspace of $(A, G_A)$.
    We say that $A'$ is rooted in $A$ if $G_{A'} \subseteq G_A$.
\end{definition}
By restricting ourselves to rooted assembly subspaces we tie the particular processes which they represent to the generating set of the larger space.
...
\begin{center}
    \scalebox{0.6}{
        \begin{tikzpicture}
            \begin{pgfonlayer}{nodelayer}
                \node [style=site, fill=blue!20] (AB) at (0, 0) {$AB$};
                \node [scale=2] at (0, -2.8) {a. Not Rooted in $\A$};

                \node [style=site, fill=blue!20] (A1) at (6,  0.8) {$A$};
                \node [style=site, fill=blue!20] (B1) at (6, -0.8) {$B$};
                \node [style=transition] (beta1) at (8, 0) {$\beta$};
                \node [style=site] (AB1) at (10, 0) {$AB$};
                \node [scale=2] at (8, -2.8) {b. Rooted in $\A$};
            \end{pgfonlayer}
            \begin{pgfonlayer}{edgelayer}
                \draw [style=arrow] (A1) to (beta1);
                \draw [style=arrow] (B1) to (beta1);
                \draw [style=arrow] (beta1) to (AB1);
            \end{pgfonlayer}
        \end{tikzpicture}
    }
\end{center}
Without requiring that the subspaces be rooted, we find the unenlightening subspace containing only $AB$ as a site and no transitions.
...
This point will be further addressed in \Cref{sec:assembly-index}.
...
As an example of an assembly map, we can use the example map from the Petri net section:
\begin{center}
    \scalebox{0.6}{
        \begin{tikzpicture}
            \begin{pgfonlayer}{nodelayer}
                \node [scale=3] (P) at (12, 0) {$\A$};
                \node [style=site, fill=blue!20] (A) at (0, 0.8) {$A$};
                \node [style=site, fill=blue!20] (B) at (0, -0.8) {$B$};
                \node [style=site, fill=blue!20] (C) at (6, -1.6) {$C$};
                \node [style=site] (AA) at (4, 0.8) {$AA$};
                ...
                \node [scale=3] (Q) at (12, -6) {$\C$};
                \node [style=site, fill=blue!20] (W) at (-4, -6) {$W$};
                \node [style=site, draw=ForestGreen] (X) at (0, -6) {$X$};
                \node [style=site, draw=ForestGreen] (Y) at (4, -6) {$Y$};
                \node [style=site, draw=ForestGreen] (Z) at (8, -6) {$Z$};
                \node [style=transition] (tau5) at (-2, -6) {$\phi$};
                \node [style=transition, draw=ForestGreen] (tau6) at (2, -6) {$\chi$};
                \node [style=transition, draw=ForestGreen] (tau7) at (6, -6) {$\psi$};
                \node [style=transition, draw=ForestGreen] (tau8) at (10, -6) {$\omega$};
            ...
            \begin{pgfonlayer}{edgelayer}
                ...
                \draw [style=arrow, draw=gray!80, bend left=15] (tau5) to (X);
                \draw [style=arrow, draw=gray!80, bend right=15] (tau5) to (X);
                \draw [style=arrow, draw=ForestGreen, bend left=15] (X) to (tau6);
                \draw [style=arrow, draw=ForestGreen, bend right=15] (X) to (tau6);
                \draw [style=arrow, draw=ForestGreen] (tau6) to (Y);
                \draw [style=arrow, draw=ForestGreen, bend left=20] (Y) to (tau7);
                \draw [style=arrow, draw=ForestGreen] (Y) to (tau7);
                \draw [style=arrow, draw=ForestGreen, bend right=20] (Y) to (tau7);
                \draw [style=arrow, draw=ForestGreen] (tau7) to (Z);
                \draw [style=arrow, draw=ForestGreen, bend left=50] (tau7.south) to (Y.south);
                \draw [style=arrow, draw=ForestGreen] (Z) to (tau8);
                \draw [style=arrow, draw=ForestGreen, bend left=30] (tau8) to (X);
                \draw [style=arrow, draw=ForestGreen, bend right=30] (tau8) to (X);
                \draw [style=arrow, draw=ForestGreen, bend right=30] (tau8) to (Y);
...
\begin{center}
    \scalebox{0.6}{
        \begin{tikzpicture}
            \begin{pgfonlayer}{nodelayer}
                \node [scale=3] (P) at (12, 0) {$\A$};
                \node [style=site, fill=blue!20, draw=red, line width=1.5] (A) at (0, 0.8) {$A$};
                \node [style=site, fill=blue!20, draw=red, line width=1.5] (B) at (0, -0.8) {$B$};
                \node [style=site] (C) at (6, -1.6) {$C$};
                \node [style=site, draw=red, line width=1.5] (AA) at (4, 0.8) {$AA$};
                \node [style=site, draw=red, line width=1.5] (AB) at (4, -0.8) {$AB$};
                \node [style=site] (AAAB) at (8, 0) {$AAAB$};
                \node [style=transition, draw=red, line width=1.5] (tau1) at (2, 0.8) {$\alpha$};
                \node [style=transition, draw=red, line width=1.5] (tau2) at (2, -0.8) {$\beta$};
                \node [style=transition] (tau3) at (6, 0) {$\gamma$};
                \node [style=transition] (tau4) at (10, 0) {$\delta$};

                \node [scale=3] (Q) at (12, -6) {$\C$};
                \node [style=site, fill=blue!20] (W) at (-4, -6) {$W$};
                \node [style=site, draw=red, line width=1.5] (X) at (0, -6) {$X$};
                \node [style=site, draw=red, line width=1.5] (Y) at (4, -6) {$Y$};
                \node [style=site, draw=ForestGreen] (Z) at (8, -6) {$Z$};
                \node [style=transition] (tau5) at (-2, -6) {$\phi$};
                \node [style=transition, draw=red, line width=1.5] (tau6) at (2, -6) {$\chi$};
                \node [style=transition, draw=ForestGreen] (tau7) at (6, -6) {$\psi$};
                \node [style=transition, draw=ForestGreen] (tau8) at (10, -6) {$\omega$};
            \end{pgfonlayer}
            \begin{pgfonlayer}{edgelayer}
                \draw [style=arrow, draw=red, line width=1.5, bend right=15] (A) to (tau1);
                \draw [style=arrow, draw=red, line width=1.5, bend left=15] (A) to (tau1);
                \draw [style=arrow, draw=red, line width=1.5, bend right=15] (A) to (tau2);
                \draw [style=arrow, draw=red, line width=1.5] (tau1) to (AA);
                \draw [style=arrow, draw=red, line width=1.5] (B) to (tau2);
                \draw [style=arrow, draw=red, line width=1.5] (tau2) to (AB);
                \draw [style=arrow, draw=gray!80] (AA) to (tau3);
                \draw [style=arrow, draw=gray!80] (AB) to (tau3);
                \draw [style=arrow, draw=gray!80, bend left=30] (C) to (tau3);
                \draw [style=arrow, draw=gray!80] (tau3) to (AAAB);
                ...
                \draw [style=arrow, draw=gray!80, bend left=15] (tau5) to (X);
                \draw [style=arrow, draw=gray!80, bend right=15] (tau5) to (X);
                \draw [style=arrow, draw=red, line width=1.5, bend left=15] (X) to (tau6);
                \draw [style=arrow, draw=red, line width=1.5, bend right=15] (X) to (tau6);
                \draw [style=arrow, draw=red, line width=1.5] (tau6) to (Y);
                \draw [style=arrow, draw=ForestGreen, bend left=20] (Y) to (tau7);
                \draw [style=arrow, draw=ForestGreen] (Y) to (tau7);
                \draw [style=arrow, draw=ForestGreen, bend right=20] (Y) to (tau7);
                \draw [style=arrow, draw=ForestGreen] (tau7) to (Z);
                ...
                \draw [style=sitemap, opacity=0.5,  bend right=30] (A) to (X);
                \draw [style=sitemap, opacity=0.5,  bend right=30] (B) to (X);
                \draw [style=sitemap, opacity=0.5,  bend right=30] (AA) to (Y);
                \draw [style=sitemap, opacity=0.5,  bend right=30] (AB) to (Y);
                \draw [style=sitemap, opacity=0.5,  bend right=30] (C) to (Y);
                \draw [style=sitemap, opacity=0.5,  bend right=30] (AAAB) to (Z);
                \draw [style=transitionmap, opacity=0.5,  bend right=30] (tau1) to (tau6);
                \draw [style=transitionmap, opacity=0.5,  bend right=30] (tau2) to (tau6);
                \draw [style=transitionmap, opacity=0.5,  bend right=30] (tau3) to (tau7);
                \draw [style=transitionmap, opacity=0.5,  bend right=30] (tau4) to (tau8);
            \end{pgfonlayer}
        \end{tikzpicture}
    }
\end{center}
This too will always be the case: the image of a rooted subspace will always be rooted in the image.
\begin{theorem}\label{thm:rooted-image}
    ...
    Then $(f(Z), S(f)(G_Z))$ is rooted in $(f(A), S(f)(G_A)$.
\end{theorem}
\begin{proof}
    \TODO{Complete}
\end{proof}
...
The assembly index, as we have defined it, is dependent on the choice of generating set.
To make this point clear, we will first consider the example assembly space $\A$ and present the assembly index and a representative minimal assembly subspace for each site.
\begin{center}
    \scalebox{0.6}{
        \begin{tikzpicture}
            \begin{pgfonlayer}{nodelayer}
                \node [scale=3] (P) at (1, 9) {$\A$};
                \node [style=site, fill=blue!20] (A) at (0, 7.4) {$A$};
                \node [style=site, fill=blue!20] (B) at (0, 5.8) {$B$};
                \node [style=site, fill=blue!20] (C) at (6, 5) {$C$};
                \node [style=site] (AA) at (4, 7.4) {$AA$};
                \node [style=site] (AB) at (4, 5.8) {$AB$};
                \node [style=site] (AAAB) at (8, 6.6) {$AAAB$};
                \node [style=transition] (alpha) at (2, 7.4) {$\alpha$};
                \node [style=transition] (beta) at (2, 5.8) {$\beta$};
                \node [style=transition] (gamma) at (6, 6.6) {$\gamma$};
                \node [style=transition] (delta) at (10, 6.6) {$\delta$};

                \node [style=site, fill=blue!20] (A0) at (0, 0) {$A$};
                \node [scale=2] at (0, -2) {$c_\A(A) = 0$};

                \node [style=site, fill=blue!20] (B1) at (4, 0) {$B$};
                \node [scale=2] at (4, -2) {$c_\A(B) = 0$};

                \node [style=site, fill=blue!20] (C2) at (8, 0) {$C$};
                \node [scale=2] at (8, -2) {$c_\A(C) = 0$};

                \node [style=site, fill=blue!20] (A3) at (12, 0) {$A$};
                \node [style=transition] (alpha3) at (12, 2) {$\alpha$};
                \node [style=site] (AA3) at (12, 4) {$AA$};
                \node [scale=2] at (12, -2) {$c_\A(AA) = 1$};

                \node [style=site, fill=blue!20] (A4) at (16, 0) {$A$};
                \node [style=site, fill=blue!20] (B4) at (17.6, 0) {$B$};
                \node [style=transition] (beta4) at (16.8, 2) {$\beta$};
                \node [style=site] (AB4) at (16.8, 4) {$AB$};
                \node [scale=2] at (16.8, -2) {$c_\A(AB) = 1$};

                \node [style=site, fill=blue!20] (A5) at (21.6, 0) {$A$};
                \node [style=site, fill=blue!20] (B5) at (23.2, 0) {$B$};
                \node [style=transition] (alpha5) at (21.6, 2) {$\alpha$};
                \node [style=transition] (beta5) at (23.2, 2) {$\beta$};
                \node [style=site] (AA5) at (21.6, 4) {$AA$};
                \node [style=site] (AB5) at (23.2, 4) {$AB$};
                \node [style=site, fill=blue!20] (C5) at (24, 6) {$C$};
                \node [style=transition] (gamma5) at (22.4, 6) {$\gamma$};
                \node [style=site] (AAAB5) at (22.4, 8) {$AAAB$};
                \node [scale=2] at (22.4, -2) {$c_\A(AAAB) = 3$};
            \end{pgfonlayer}
            \begin{pgfonlayer}{edgelayer}
                \draw [style=arrow, bend right=15] (A) to (alpha);
                \draw [style=arrow, bend left=15] (A) to (alpha);
                \draw [style=arrow] (alpha) to (AA);
                \draw [style=arrow, bend right=15] (A) to (beta);
                \draw [style=arrow] (B) to (beta);
                \draw [style=arrow] (beta) to (AB);
                \draw [style=arrow] (AA) to (gamma);
                \draw [style=arrow] (AB) to (gamma);
                \draw [style=arrow, bend left=30] (C) to (gamma);
                \draw [style=arrow, bend left=30] (gamma) to (C);
                \draw [style=arrow] (gamma) to (AAAB);
                \draw [style=arrow] (AAAB) to (delta);
                \draw [style=arrow, bend right=30] (delta) to (A);
                \draw [style=arrow, bend right=30] (delta) to (AA);
                \draw [style=arrow, bend left=40] (delta) to (B);

                \draw [style=arrow, bend left=15] (A3) to (alpha3);
                \draw [style=arrow, bend right=15] (A3) to (alpha3);
                \draw [style=arrow] (alpha3) to (AA3);

                \draw [style=arrow] (A4) to (beta4);
                \draw [style=arrow] (B4) to (beta4);
                \draw [style=arrow] (beta4) to (AB4);

                \draw [style=arrow, bend left=15] (A5) to (alpha5);
                \draw [style=arrow, bend right=15] (A5) to (alpha5);
                \draw [style=arrow] (alpha5) to (AA5);
                \draw [style=arrow, bend right=15] (A5) to (beta5);
                \draw [style=arrow] (B5) to (beta5);
                \draw [style=arrow] (beta5) to (AB5);
                \draw [style=arrow] (AA5) to (gamma5);
                \draw [style=arrow] (AB5) to (gamma5);
                \draw [style=arrow, bend left=30] (C5) to (gamma5);
                \draw [style=arrow, bend left=30] (gamma5) to (C5);
                \draw [style=arrow] (gamma5) to (AAAB5);
            \end{pgfonlayer}
        \end{tikzpicture}
    }
\end{center}
However, if we were to have chosen a different generating set, say $\{C, AAAB\}$, while retaining the same underlying Petri net the results would have been quite different.
\begin{center}
    \scalebox{0.6}{
        \begin{tikzpicture}
            \begin{pgfonlayer}{nodelayer}
                \node [scale=3] (P) at (1, 10.2) {$\A'$};
                \node [style=site, fill=blue!20] (AAAB) at (0, 7.8) {$AAAB$};
                \node [style=transition] (delta) at (2, 7.8) {$\delta$};
                \node [style=site] (A) at (4, 8.6) {$A$};
                \node [style=site] (B) at (4, 7.0) {$B$};
                \node [style=transition] (alpha) at (6, 8.6) {$\alpha$};
                \node [style=transition] (beta) at (6, 7.0) {$\beta$};
                \node [style=site] (AA) at (8, 8.6) {$AA$};
                \node [style=site] (AB) at (8, 7.0) {$AB$};
                \node [style=site, fill=blue!20] (C) at (10, 9.4) {$C$};
                \node [style=transition] (gamma) at (10, 7.8) {$\gamma$};

                \node [style=site, fill=blue!20] (AAAB0) at (0, 0) {$AAAB$};
                \node [scale=2] at (0, -2) {$c_{\A'}(AAAB) = 0$};

                \node [style=site, fill=blue!20] (C1) at (6, 0) {$C$};
                \node [scale=2] at (6, -2) {$c_{\A'}(C) = 0$};

                \node [style=site, fill=blue!20] (AAAB2) at (13.6, 0) {$AAAB$};
                \node [style=transition] (delta2) at (13.6, 2) {$\delta$};
                \node [style=site] (A2) at (12, 4) {$A$};
                \node [style=site] (B2) at (13.6, 4) {$B$};
                \node [style=site] (AA2) at (15.2, 4) {$AA$};
                \node [scale=2] at (13.6, -2) {$c_{\A'}(A) = c_{\A'}(B) = c_{\A'}(AA) = 1$};

                \node [style=site, fill=blue!20] (AAAB3) at (22, 0) {$AAAB$};
                \node [style=transition] (delta3) at (22, 2) {$\delta$};
                \node [style=site] (A3) at (21.2, 4) {$A$};
                \node [style=site] (B3) at (22.8, 4) {$B$};
                \node [style=site] (AA3) at (23.6, 2) {$AA$};
                \node [style=transition] (beta3) at (22, 6) {$\beta$};
                \node [style=site] (AB3) at (22, 8) {$AB$};
                \node [scale=2] at (22, -2) {$c_{\A'}(AB) = 2$};
            \end{pgfonlayer}
            \begin{pgfonlayer}{edgelayer}
                \draw [style=arrow] (AAAB) to (delta);
                \draw [style=arrow] (delta) to (A);
                \draw [style=arrow, bend left=40] (delta.north) to (AA);
                \draw [style=arrow] (delta) to (B);
                \draw [style=arrow, bend right=15] (A) to (alpha);
                \draw [style=arrow, bend left=15] (A) to (alpha);
                \draw [style=arrow] (alpha) to (AA);
                \draw [style=arrow, bend right=15] (A) to (beta);
                ...
                \draw [style=arrow] (AA) to (gamma);
                \draw [style=arrow] (AB) to (gamma);
                \draw [style=arrow, bend right=30] (C) to (gamma);
                \draw [style=arrow, bend right=30] (gamma) to (C);
                \draw [style=arrow, bend left=40] (gamma.south) to (AAAB);

                \draw [style=arrow] (AAAB2) to (delta2);
                \draw [style=arrow] (delta2) to (AA2);
                \draw [style=arrow] (delta2) to (A2);
                \draw [style=arrow] (delta2) to (B2);

                \draw [style=arrow] (AAAB3) to (delta3);
                \draw [style=arrow] (delta3) to (A3);
                \draw [style=arrow] (delta3) to (B3);
                \draw [style=arrow] (delta3) to (AA3);
                \draw [style=arrow] (A3) to (beta3);
                \draw [style=arrow] (B3) to (beta3);
                \draw [style=arrow] (beta3) to (AB3);
            \end{pgfonlayer}
        \end{tikzpicture}
...
\end{center}
While this may seem, at first glance, to be undesirable it captures a very important point about the assembly process: the materials that you start with greatly influence how difficult, complex or costly assembling a given object may be.
The cases of interest in this work presume that we being with only ``simple" objects from which we aim to build more ``complex" objects.
However, the formalism, in and of itself, it far more general than this.
...
The the remaining examples, we will depart from using $\A$ since large enough to demonstrate the desired points.
Consider the assembly space and subspace depicted below:
\begin{center}
    \scalebox{0.6}{
        \begin{tikzpicture}
            \begin{pgfonlayer}{nodelayer}
                \node [style=site, fill=blue!20] (A) at (0, 0) {$A$};
                \node [style=site] (B) at (4, 0) {$B$};
                \node [style=site] (C) at (8, 0) {$C$};
                \node [style=site] (D) at (12, 0) {$D$};
                \node [style=site] (E) at (16, 0) {$E$};
                \node [style=site] (F) at (20, 0) {$F$};
                \node [style=transition] (a) at (2, 0) {$\alpha$};
                \node [style=transition] (b) at (6, 0) {$\beta$};
                \node [style=transition] (c) at (10, 0) {$\gamma$};
                \node [style=transition] (d) at (14, 0) {$\delta$};
                \node [style=transition] (e) at (18, 0) {$\epsilon$};
                \node [style=transition] (f) at (8, 2) {$\zeta$};
                \node [style=transition] (g) at (12, -4) {$\eta$};
                \node [style=transition] (h) at (16, -3) {$\theta$};
                \node [style=transition] (i) at (14, 3) {$\iota$};
            \end{pgfonlayer}
            \begin{pgfonlayer}{edgelayer}
                \draw [style=arrow, bend left=25, draw=gray!70] (B) to (f);
                \draw [style=arrow, bend left=10, draw=gray!70] (B) to (f);
                \draw [style=arrow, bend left=25, draw=gray!70] (f) to (D);

                \draw [style=arrow, bend right=10, draw=gray!80] (B) to (g);
                \draw [style=arrow, bend right=10, draw=gray!80] (C) to (g);
                \draw [style=arrow, bend right=10, draw=gray!80] (g) to (E);

                \draw [style=arrow, bend right=10, draw=gray!90] (B) to (h);
                \draw [style=arrow, bend right=10, draw=gray!90] (D) to (h);
                \draw [style=arrow, bend right=10, draw=gray!90] (h) to (F);

                \draw [style=arrow, bend left=25, draw=gray!80] (C) to (i);
                \draw [style=arrow, bend left=10, draw=gray!80] (C) to (i);
                \draw [style=arrow, bend left=25, draw=gray!80] (i) to (F);

                \draw [style=arrow, draw=red, bend left=15] (A) to (a);
                \draw [style=arrow, draw=red, bend right=15] (A) to (a);
                \draw [style=arrow, draw=red, bend right=30] (A) to (b);
                \draw [style=arrow, draw=red, bend right=30] (A) to (c);
                \draw [style=arrow, draw=red, bend right=30] (A) to (d);
                \draw [style=arrow, draw=red, bend right=30] (A) to (e);
                \draw [style=arrow, draw=red] (a) to (B);
                \draw [style=arrow, draw=red] (B) to (b);
                \draw [style=arrow, draw=red] (b) to (C);
                \draw [style=arrow, draw=red] (C) to (c);
                \draw [style=arrow, draw=red] (c) to (D);
                \draw [style=arrow, draw=red] (D) to (d);
                \draw [style=arrow, draw=red] (d) to (E);
                \draw [style=arrow, draw=red] (E) to (e);
                \draw [style=arrow, draw=red] (e) to (F);
            \end{pgfonlayer}
        \end{tikzpicture}
    }
\end{center}
...
\begin{center}
    \scalebox{0.6}{
        \begin{tikzpicture}
            \begin{pgfonlayer}{nodelayer}
                \node [scale=3] at (15, 12) {$\mathcal{N}$};
                \node [style=site, fill=blue!20] (A) at (13, 0) {$1$};
                \node [style=site] (B) at (13, 4) {$2$};
                \node [style=site] (C) at (13, 8) {$3$};
                \node [style=site] (D) at (13, 12) {$4$};
                \node [style=transition, scale=0.5] (a) at (13, 2) {};
                \node [style=transition, scale=0.5] (b) at (13, 6) {};
                \node [style=transition, scale=0.5] (c) at (13, 10) {};
                \node [style=transition, scale=0.5] (d) at (11, 8) {};

                \node [scale=3] at (-2, 14) {$\mathcal{B}$};
                \node [style=site, fill=blue!20] (0) at (-2, 0) {$0$};
                \node [style=site, fill=blue!20] (1) at ( 2, 0) {$1$};
                \node [style=transition, scale=0.5] (a00) at (-3, 2) {};
                \node [style=transition, scale=0.5] (a10) at ( 0, 2) {};
                \node [style=transition, scale=0.5] (a11) at ( 3, 2) {};
                \node [style=site] (00) at (-4, 4) {$00$};
                \node [style=site] (10) at ( 0, 4) {$10$};
                \node [style=site] (11) at ( 4, 4) {$11$};
                \node [style=transition, scale=0.5] (a100a) at (-3, 6) {};
                \node [style=transition, scale=0.5] (a100b) at (-1, 6) {};
                \node [style=transition, scale=0.5] (a110a) at ( 1, 6) {};
                \node [style=transition, scale=0.5] (a110b) at ( 3, 6) {};
                \node [style=site] (100) at (-2, 8) {$100$};
                \node [style=site] (110) at ( 2, 8) {$110$};
                \node [style=transition, scale=0.5] (a1100a) at (-1, 10) {};
                \node [style=transition, scale=0.5] (a1100b) at ( 1, 10) {};
                \node [style=transition, scale=0.5] (a1100c) at ( 0, 14) {};
                \node [style=site] (1100) at (0, 12) {$1100$};
            \end{pgfonlayer}
            \begin{pgfonlayer}{edgelayer}
                \draw [style=sitemap, opacity=0.5, bend left=15] (0) to (A);
                \draw [style=sitemap, opacity=0.5, bend left=15] (1) to (A);
                \draw [style=sitemap, opacity=0.5, bend left=15] (00) to (B);
                \draw [style=sitemap, opacity=0.5, bend left=15] (10) to (B);
                \draw [style=sitemap, opacity=0.5, bend left=15] (11) to (B);
                \draw [style=sitemap, opacity=0.5, bend left=15] (100) to (C);
                \draw [style=sitemap, opacity=0.5, bend left=15] (110) to (C);
                \draw [style=sitemap, opacity=0.5, bend left=15] (1100) to (D);
                \draw [style=transitionmap, opacity=0.5, bend left=15] (a00) to (a);
                \draw [style=transitionmap, opacity=0.5, bend left=15] (a10) to (a);
                \draw [style=transitionmap, opacity=0.5, bend left=15] (a11) to (a);
                \draw [style=transitionmap, opacity=0.5, bend left=15] (a100a) to (b);
                \draw [style=transitionmap, opacity=0.5, bend left=15] (a100b) to (b);
                \draw [style=transitionmap, opacity=0.5, bend left=15] (a110a) to (b);
                \draw [style=transitionmap, opacity=0.5, bend left=15] (a110b) to (b);
                \draw [style=transitionmap, opacity=0.5, bend left=15] (a1100a) to (c);
                \draw [style=transitionmap, opacity=0.5, bend left=15] (a1100b) to (c);
                \draw [style=transitionmap, opacity=0.5] (a1100c) to (d);

                \draw [style=arrow, draw=ForestGreen, line width=1.5, bend left=15] (A) to (a);
                \draw [style=arrow, draw=ForestGreen, line width=1.5, bend right=15] (A) to (a);
                \draw [style=arrow, draw=gray!80, bend right=30] (A) to (b);
                \draw [style=arrow, draw=gray!80, bend right=30] (A) to (c);
                \draw [style=arrow, draw=ForestGreen, line width=1.5] (a) to (B);
                \draw [style=arrow, draw=gray!80] (B) to (b);
                \draw [style=arrow, draw=gray!80] (b) to (C);
                \draw [style=arrow, draw=gray!80] (C) to (c);
                \draw [style=arrow, draw=gray!80] (c) to (D);
                \draw [style=arrow, bend left=25, draw=ForestGreen, line width=1.5] (B) to (d);
                \draw [style=arrow, bend left=10, draw=ForestGreen, line width=1.5] (B) to (d);
                \draw [style=arrow, bend left=25, draw=ForestGreen, line width=1.5] (d) to (D);

                \draw [style=arrow, draw=ForestGreen, line width=1.5, bend left=15] (0) to (a00);
                \draw [style=arrow, draw=ForestGreen, line width=1.5, bend right=15] (0) to (a00);
                \draw [style=arrow, draw=ForestGreen, line width=1.5] (0) to (a10);
                \draw [style=arrow, draw=ForestGreen, line width=1.5, bend left=15] (1) to (a11);
                \draw [style=arrow, draw=ForestGreen, line width=1.5, bend right=15] (1) to (a11);
                \draw [style=arrow, draw=ForestGreen, line width=1.5] (1) to (a10);
                \draw [style=arrow, draw=ForestGreen, line width=1.5] (a00) to (00);
                \draw [style=arrow, draw=gray!80] (a10) to (10);
                \draw [style=arrow, draw=ForestGreen, line width=1.5] (a11) to (11);
                \draw [style=arrow, draw=gray!80] (00) to (a100a);
                \draw [style=arrow, draw=gray!80] (10) to (a100b);
                \draw [style=arrow, draw=gray!80] (10) to (a110a);
                \draw [style=arrow, draw=gray!80] (11) to (a110b);
                \draw [style=arrow, draw=gray!80, bend left=30] (1) to (a100a);
                \draw [style=arrow, draw=gray!80, bend left=10] (0) to (a100b);
                \draw [style=arrow, draw=gray!80, bend right=10] (1) to (a110a);
                \draw [style=arrow, draw=gray!80, bend right=30] (0) to (a110b);
                \draw [style=arrow, draw=gray!80] (a100a) to (100);
                \draw [style=arrow, draw=gray!80] (a100b) to (100);
                \draw [style=arrow, draw=gray!80] (a110a) to (110);
                \draw [style=arrow, draw=gray!80] (a110b) to (110);
                \draw [style=arrow, draw=gray!80] (100) to (a1100a);
                \draw [style=arrow, draw=gray!80] (110) to (a1100b);
                \draw [style=arrow, draw=gray!80, bend right=5] (1) to (a1100a);
                \draw [style=arrow, draw=gray!80, bend left=5] (0) to (a1100b);
                \draw [style=arrow, draw=gray!80] (a1100a) to (1100);
                \draw [style=arrow, draw=gray!80] (a1100b) to (1100);
                \draw [style=arrow, draw=ForestGreen, line width=1.5, bend left=15] (00) to (a1100c);
                \draw [style=arrow, draw=ForestGreen, line width=1.5, bend right=15] (11) to (a1100c);
                \draw [style=arrow, draw=ForestGreen, line width=1.5] (a1100c) to (1100);
            \end{pgfonlayer}
        \end{tikzpicture}
    }
\end{center}
Minimal, rooted subspaces of minimum size are highlighed in green in both cases.
It is easy to see that the assembly index of $1100$ is $c_{\mathcal{B}}(1100) = 3$ while the index of $4$ is $c_{\mathcal{N}}(4) = 2$, so of course $c_{\mathcal{N}}(4) \le c_{\mathcal{B}}(1100)$.
The only reason these two indices are directly comparable is that $\mathcal{B}$ maps onto $\mathcal{N}$, and as such the entire space $\mathcal{N}$ is the image of $\mathcal{B}$.
If this were not the case, special care would have to be taken to ensure that only transitions in $f(\mathcal{B})$ were considered.

Our final bound is a special case of the lower bound derived from an assembly map; however, it represents an upper bound.
Given an assembly space with no directed loops, which we refer to as \textbf{acyclic}, we can form an analogous assembly space which has a tree-like structure by duplicating sites that participate in more than one pathway.
