...
\begin{definition}\label{def:pathway-connected}
    \TODO{Update this to reflect changes in the definition of a pathway.}
...
\TODO{Update this example to reflect changes in the definition of a pathway.}
...
\begin{lemma}\label{lem:image-of-pathways}
    \TODO{Update this proof to reflect changes to the definition of a pathway.}
